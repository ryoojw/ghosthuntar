...
import com.ghosthuntar.gui.RadarPoints;
import com.ghosthuntar.mgr.downloader.DownloadManager;
import com.ghosthuntar.mgr.downloader.DownloadRequest;
import com.ghosthuntar.mgr.downloader.DownloadResult;
		...
		while ((dRes = dm.getNextResult()) != null) {
			...
			if(!dRes.isError()) {
				if(dRes.getMarkers() != null){
					...
					Log.i(GameView.TAG,"Adding Markers");
