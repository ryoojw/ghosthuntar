...
import com.ghosthuntar.mgr.datasource.DataSourceManager;
import com.ghosthuntar.mgr.datasource.DataSourceManagerFactory;
import com.ghosthuntar.mgr.downloader.DownloadManager;
import com.ghosthuntar.mgr.downloader.DownloadManagerFactory;
import com.ghosthuntar.mgr.location.LocationFinder;
import com.ghosthuntar.mgr.location.LocationFinderFactory;
import com.ghosthuntar.mgr.webcontent.WebContentManager;
import com.ghosthuntar.mgr.webcontent.WebContentManagerFactory;
...
public class MixContext extends ContextWrapper implements MixContextInterface {
	...
	public MixContext(GameView appCtx) {
		super(appCtx);
		mixView = appCtx;
	...
	public void doResume(GameView mixView) {
	...
	public GameView getActualMixView() {
		synchronized (mixView) {
			return this.mixView;
		}
	}

	private void setActualMixView(GameView mv) {
		synchronized (mixView) {
			this.mixView = mv;
		}
	}
