...
public class DataSource extends Activity {
	...
	public enum TYPE {
		WIKIPEDIA, BUZZ, TWITTER, OSM, MIXARE, ARENA, GHOSTHUNTAR
	};
	...
	public String createRequestParams(double lat, double lon, double alt,
		...
		if (!ret.startsWith("file://")) {
			...
			case GHOSTHUNTAR:
				ret += "/latitude/" + Double.toString(lat) + "/longitude/" + Double.toString(lon);
				break;
