...
<head>
	...
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1BqQUep7SlCc2YCo196gN6w7vw36D0RQ&sensor=false&region=gb"></script>
			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					...
					<ul class="nav">
						...
						<li class="active"><a href="<?php echo Yii::app()->createUrl('/gameWorld'); ?>">Game World</a></li>
			...
			<!--<div class="span3">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li><a href="#">Choose your character</a></li>
						
						<li class="nav-header">Gameplay</li>
						<li><a href="#">Fundamentals</a></li>
						<li><a href="#">Ghosts</a></li>
						
						<li class="nav-header">Items</li>
						<li><a href="#">Capturing</a></li>
